...
celemento <- gsub(';','  \n',as.character(elemento))
x = is.na.data.frame(elemento) 
if(x){cat('')} else {cat("**Completion time**")}
```
...
```{r pergunta 68, echo=FALSE, results='asis'}
...
```{r resposta 68, echo=FALSE, results='asis'}
elemento <- df[linha,68]
celemento <- gsub(';','  \n',as.character(elemento))
x = is.na.data.frame(elemento) 
if(x){cat('')} else {cat(celemento)}
...
```{r pergunta 69, echo=FALSE, results='asis'}
...
```{r resposta 69, echo=FALSE, results='asis'}
elemento <- df[linha,69]
celemento <- gsub(';','  \n',as.character(elemento))
x = is.na.data.frame(elemento) 
if(x){cat('')} else {cat(celemento)}
...
```{r pergunta 70, echo=FALSE, results='asis'}
...
```{r resposta 70, echo=FALSE, results='asis'}
elemento <- df[linha,70]
celemento <- gsub(';','  \n',as.character(elemento))
x = is.na.data.frame(elemento) 
if(x){cat('')} else {cat(celemento)}
...
```{r pergunta 71, echo=FALSE, results='asis'}
...
```{r resposta 71, echo=FALSE, results='asis'}
elemento <- df[linha,71]
celemento <- gsub(';','  \n',as.character(elemento))
x = is.na.data.frame(elemento) 
if(x){cat('')} else {cat(celemento)}
